...
int main(void)
{
	...
	//ADDED
	GLuint colorGreen = glGetUniformLocation(programID, "colorGreen");
	GLuint toggleLight = glGetUniformLocation(programID, "toggleLight");
	...
	float headDist = 1.85;
	float flatDist = 1.1;
	float rectangleLen = 4.0;

	static const GLfloat glVertexBufferData[] = {
			-rectangleLen, -rectangleLen, 0.0f,
			-rectangleLen, rectangleLen, 0.0f,
			rectangleLen, -rectangleLen, 0.0f,
			rectangleLen, rectangleLen, 0.0f,
	};
	...
	do {
		...
		// ADDED
		glfwSetKeyCallback(window, callbackForKeys);
		if (lighting)
			glUniform1i(toggleLight, 1);
		else
			glUniform1i(toggleLight, 0);
        ...
        // Use our shader
        glUseProgram(programID);
        glUniform1i(colorGreen, 0);
        glm::vec3 lightPos = glm::vec3(4, 4, 4);
        glUniform3f(LightID, lightPos.x, lightPos.y, lightPos.z);
        glUniformMatrix4fv(ViewMatrixID, 1, GL_FALSE, &ViewMatrix[0][0]);

        glm::mat4 ModelMatrix1 = glm::mat4(1.0);
        ModelMatrix1 = glm::translate(ModelMatrix1, glm::vec3(0.0f, 0.0f, flatDist));
        ...
        ModelMatrix1 = glm::translate(ModelMatrix1, glm::vec3(0.0f, 0.0f, headDist));
        ...
        ModelMatrix2 = glm::translate(ModelMatrix2, glm::vec3(0.0f, 0.0f, flatDist));
        ...
        ModelMatrix2 = glm::translate(ModelMatrix2, glm::vec3(0.0f, 0.0f, headDist));
        ...
        ModelMatrix3 = glm::translate(ModelMatrix3, glm::vec3(0.0f, 0.0f, flatDist));
        ModelMatrix3 = glm::translate(ModelMatrix3, glm::vec3(0.0f, -headDist, 0.0f));
        ...
        ModelMatrix4 = glm::translate(ModelMatrix4, glm::vec3(0.0f, 0.0f, flatDist));
        ModelMatrix4 = glm::translate(ModelMatrix4, glm::vec3(0.0f, headDist, 0.0f));
        ModelMatrix4 = glm::rotate(ModelMatrix4, glm::radians(90.0f), glm::vec3(1.0f, 0.0f, 0.0f));
        ModelMatrix4 = glm::rotate(ModelMatrix4, glm::radians(180.0f), glm::vec3(0.0f, 1.0f, 0.0f));
        ...
        glUniform1i(colorGreen, 1);
        glm::mat4 ModelMatrixRect = glm::mat4(1.0);
        glUseProgram(programID);
        glm::mat4 MVP5 = ProjectionMatrix * ViewMatrix * ModelMatrixRect;
